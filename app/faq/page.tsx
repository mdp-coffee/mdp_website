...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "MDP Coffee House operates across 15+ cities in India including Bengaluru, Hyderabad, Mumbai, Pune, Chennai, Delhi, Kolkata, Jaipur, Kochi, Goa, Ayodhya and more. With 85+ locations nationwide, MDP is one of India's most widely distributed corporate coffee services.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "MDP Coffee House was founded in 2005 with a single kiosk at Accenture's Vikhroli office in Mumbai. In twenty years, MDP has grown to 85+ locations across 15+ cities in India, serving over 1,00,000 cups every day.",
      },
    },
    {
      "@type": "Question",
