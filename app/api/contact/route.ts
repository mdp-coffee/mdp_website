...
export async function POST(request: Request) {
  ...
  try {
    ...
    await resend.emails.send({
      ...
      to: (source === "careers" || source === "job-application")
        ? "hr@mdpcoffeehouse.com"
      ...
      subject: source === "careers"
        ...
        ? `Job Application (${company}) from ${name}`
        : source === "franchise"
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 560px; margin: 0 auto;">
    <tr>
      <td style="background: #411915; padding: 32px 40px;">
        ...
        ${source === "careers" ? `<p style="margin: 8px 0 0; font-family: Arial, sans-serif; font-size: 11px; color: #FEC87F; opacity: 0.7; letter-spacing: 2px; text-transform: uppercase;">Career Application</p>` : source === "job-application" ? `<p style="margin: 8px 0 0; font-family: Arial, sans-serif; font-size: 11px; color: #FEC87F; opacity: 0.7; letter-spacing: 2px; text-transform: uppercase;">Job Application</p>` : source === "franchise" ? `<p style="margin: 8px 0 0; font-family: Arial, sans-serif; font-size: 11px; color: #FEC87F; opacity: 0.7; letter-spacing: 2px; text-transform: uppercase;">Franchise Enquiry</p>` : ""}
      </td>
    </tr>
    <tr>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td style="padding: 20px 0; border-bottom: 1px solid #EDE0C8;">
              <p style="margin: 0 0 4px; font-family: Arial, sans-serif; font-size: 10px; letter-spacing: 2px; text-transform: uppercase; color: #70120E;">${source === "franchise" ? "City / Area of Interest" : source === "job-application" ? "Applying For" : "Company"}</p>
