...
export function AboutContent() {
  ...
  return (
    <div className="bg-paper">
      ...
      <section
        className="relative overflow-hidden snap-slide flex min-h-[50vh] w-full flex-col justify-end bg-[#411915] px-6 pb-12 pt-24 md:px-20 md:pb-20 md:pt-32"
      ...
      {/* Section 9 — CTA */}
      <section
        className="snap-slide relative overflow-hidden flex flex-col items-center bg-[#411915] px-6 py-28 text-center md:px-20"
