...
export const cityPages: CityPageData[] = [
  {
    ...
    paragraphs: [
      ...
      "Bengaluru is home to MDP's headquarters and largest concentration of corporate clients. Companies including Infosys, Oracle, Mu Sigma, and teams at International Tech Park Bengaluru (ITPB) trust MDP Coffee House to deliver authentic South Indian filter coffee to their employees every morning — before the first meeting, before the workday begins.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "MDP serves enterprise clients in Hyderabad including Infosys, Microsoft, Wells Fargo and others operating in the city's expanding technology and financial services sector.",
    ],
    ...
    paraSections: [
      {
        ...
        text: "MDP Coffee House's first client was Accenture, Vikhroli — a relationship that began in 2005 and helped establish MDP as a trusted name in corporate coffee service across India. Today, MDP continues to serve corporate offices across Mumbai's commercial districts with the same standard of care.",
      },
    ],
  ...
  },
  {
    ...
    paragraphs: [
      "Mysore is one of MDP Coffee House's most established markets outside Bengaluru, with a strong presence across Infosys's Mysore campus — one of the largest corporate training campuses in the country — alongside IBM and commercial destinations including Mall of Mysore and PVR.",
      "MDP's Mysore operations reflect the same fully managed model used across India: trained staff, standardised recipes, and daily operations handled end-to-end, whether inside a corporate campus or a high-footfall retail location.",
    ],
  },
];
